...
//accesing all the values whatever i am inserting in input fields
      if(isset($_POST['submit']))
      {
        ...
        $mobile=$_POST['mobile'];
//insert query
          $sql="update seriescrud set id='$id',fname='$fname',lname='$lname',email='$email',mobile='$mobile'
          where id=$id";
          $result=mysqli_query($con,$sql);
            if($result)
            {
...
<html lang="en">
  ...
  <body>
    ...
    <h3>ENTER STUDENT DETAILS HERE</h3><br>
        ...
        <label>Mobile</label>
        <input type="text" placeholder="Enter your mobile" name="mobile" value=<?php echo $mobile; ?>>
